	...
	<div class="container">
		...
		<form method="POST" action="proses.php" enctype="multipart/form-data">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="text" required name="judul" class="form-control" id="judul" placeholder="Ex: akulah sang badai"
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="text" required name="penulis" class="form-control" id="penulis" placeholder="Ex: Tere Liye"
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="text" required name="penerbit" class="form-control" id="penerbit" placeholder="Ex: Gramedia"
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="text" required name="tahun_terbit" class="form-control" id="tahun_terbit" placeholder="Ex: 2000"
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="text" required name="genre" class="form-control" id="genre" placeholder="Ex: aksi"
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					...
					<input class="form-control" <?php if (!isset($_GET['ubah'])) {
						echo "required";
					} ?> type="file"
						name="foto_buku" id="foto">
				</div>
			</div>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="text" name="jumlah" class="form-control" id="jumlah" placeholder="Ex: 3"
